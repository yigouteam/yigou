...
<body class="childrenBody">
	<form class="layui-form">
		<div class="user_left">
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			    	<input type="text" value="${sessionScope.admin.name}" disabled class="layui-input layui-disabled">
			    </div>
			</div>
			<div class="layui-form-item">
		...
		<div class="user_right">
			...
			<p>显示我的的图片</p>
			<img src="${pageContext.request.contextPath}/admin/images/face.jpg" class="layui-circle" id="userFace">
		</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/address.js"></script>
